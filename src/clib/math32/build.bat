...
type i32_from_int.prg i32_from_u32.prg i32toa.prg muli32.prg muli32x16.prg >> math32.lib
...
type subu32.prg u32_from_i32.prg u32_from_int.prg u32toa.prg >> math32.lib
