...
L40:
	...
	;----- cgldgw
	 				call vpush16
	 				  dw Cp
	;----- cgldinc
	 				 call  psave        ; save pointer to pointer from stack for postfix
	;----- cgindw
	 				call deref16
	;----- cginc2iw
	          call  pinc16       ; increment variable referenced by saved pointer
	;----- cgstorgw
	 				 call vstor16       ; store value from ES in global variable
	 				  dw Cr
	;----- cgpopd
...
L42:
	...
	;----- cgldgw
	 				call vpush16
	 				  dw Cp
	;----- cginc1iw
	 				 call  psave        ; save pointer from stack
	          call  pinc16       ; increment variable referenced by saved pointer
	;----- cgindw
	 				call deref16
	;----- cgstorgw
...
L52:
	...
	;----- cgindw
	 				call deref16
	;----- cgdec2iw
	          call  pdec16       ; decrement variable referenced by saved pointer
	;----- cgstorgw
	 				 call vstor16       ; store value from ES in global variable
	 				  dw Cr
	;----- cgpopd
...
L72:
	...
	;----- cgindw
	 				call deref16
	;----- cginc2pi
	 				 call  pincptr      ; increment pointer referenced by saved pointer
	          dw  2  ;--- size
	;----- cgstorgw
	 				 call vstor16       ; store value from ES in global variable
	 				  dw Cr
...
L74:
	...
	;----- cgldgw
	 				call vpush16
	 				  dw Cpp
	;----- cginc1pi
	 				 call  psave        ; get pointer to pointer from stack for prefix
	 				 call  pincptr      ; increment pointer referenced by pointer
	          dw  2  ;--- size
	;----- cgindw
	 				call deref16
	;----- cgstorgw
...
L84:
	...
	;----- cgindw
	 				call deref16
	;----- cgdec2pi
	 				 call  pdecptr      ; decrement pointer referenced by saved pointer
	          dw  2  ;--- size
	;----- cgstorgw
	 				 call vstor16       ; store value from ES in global variable
	 				  dw Cr
...
L86:
	...
	;----- cgdec1pi
	 				 call  psave        ; get pointer to pointer from stack for prefix
	 				 call  pdecptr      ; decrement pointer referenced by pointer
	          dw  2  ;--- size
	;----- cgindw
	 				call deref16
	;----- cgstorgw
